...
// 逻辑与表达式  
logicalAndExp: logicalNotExp (T_AND logicalNotExp)*;

// 逻辑非表达式
logicalNotExp: T_NOT relationalExp | relationalExp;

// 关系表达式
relationalExp: addExp (relationalOp addExp)*;

// 关系运算符
relationalOp: T_EQ | T_NE | T_GT | T_LT | T_GE | T_LE;
