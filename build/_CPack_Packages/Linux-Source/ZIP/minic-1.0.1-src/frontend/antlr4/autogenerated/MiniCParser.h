...
public:
  enum {
    ...
    T_VOID = 24, T_IF = 25, T_ELSE = 26, T_WHILE = 27, T_BREAK = 28, T_ID = 29, 
    T_DIGIT = 30, T_OCTAL = 31, T_HEX = 32, WS = 33, LINE_COMMENT = 34, 
    BLOCK_COMMENT = 35
  };
  ...
  enum {
    ...
    RuleLogicalNotExp = 12, RuleRelationalExp = 13, RuleRelationalOp = 14, 
    RuleMulExp = 15, RuleAddExp = 16, RuleMulOp = 17, RuleAddOp = 18, RuleUnaryExp = 19, 
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<LogicalNotExpContext *> logicalNotExp();
    LogicalNotExpContext* logicalNotExp(size_t i);
  ...
  class  LogicalNotExpContext : public antlr4::ParserRuleContext {
  public:
    LogicalNotExpContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  LogicalNotExpContext* logicalNotExp();
  ...
  class  PrimaryExpRuleContext : public UnaryExpContext {
  public:
    PrimaryExpRuleContext(UnaryExpContext *ctx);
  ...
  class  NegExpContext : public UnaryExpContext {
  public:
    NegExpContext(UnaryExpContext *ctx);
  ...
  class  FuncCallRuleContext : public UnaryExpContext {
  public:
    FuncCallRuleContext(UnaryExpContext *ctx);
  ...
  class  NotExpContext : public UnaryExpContext {
  public:
    NotExpContext(UnaryExpContext *ctx);
